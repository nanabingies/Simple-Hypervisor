...
namespace hv_vmcs {
	auto dump_vmcs() -> void {
		...
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_CR3: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_CR4, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_CR4: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_ES_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_ES_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_CS_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_CS_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_SS_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_SS_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_DS_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_DS_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_FS_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_FS_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_GS_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_GS_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_LDTR_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_LDTR_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_TR_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_TR_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_GDTR_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_GDTR_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_IDTR_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_IDTR_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_DR7, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_DR7: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_RSP, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_RSP: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_RIP, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_RIP: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_RFLAGS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_RFLAGS: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_SYSENTER_ESP, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_SYSENTER_ESP: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_SYSENTER_EIP, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_SYSENTER_EIP: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_S_CET, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_S_CET: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_SSP, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_SSP: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_INTERRUPT_SSP_TABLE_ADDR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_INTERRUPT_SSP_TABLE_ADDR: 0x%llX", parm);

		// 64-bit Guest Register State Fields
		__vmx_vmread(VMCS_GUEST_VMCS_LINK_POINTER, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_VMCS_LINK_POINTER: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_DEBUGCTL, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_DEBUG_CONTROL: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_PAT, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_PAT: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_EFER, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_EFER: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_PERF_GLOBAL_CTRL, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_PERF_GLOBAL_CONTROL: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_PDPTE0, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_PDPTE0: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_PDPTE1, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_PDPTE1: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_PDPTE2, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_PDPTE2: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_PDPTE3, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_PDPTE3: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_BNDCFGS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_BNDCFGS: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_RTIT_CTL, &parm);
		LOG("[!] GUEST_RTIT_CTL: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_PKRS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_PKRS: 0x%llX", parm);

		// 32-Bit Guest Register State Fields
		__vmx_vmread(VMCS_GUEST_PKRS, &parm);
		LOG("[!] GUEST_ES_LIMIT: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_CS_LIMIT, &parm);
		LOG("[!] GUEST_CS_LIMIT: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_SS_LIMIT, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_SS_LIMIT: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_DS_LIMIT, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_DS_LIMIT: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_FS_LIMIT, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_FS_LIMIT: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_GS_LIMIT, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_GS_LIMIT: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_LDTR_LIMIT, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_LDTR_LIMIT: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_TR_LIMIT, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_TR_LIMIT: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_GDTR_LIMIT, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_GDTR_LIMIT: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_IDTR_LIMIT, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_IDTR_LIMIT: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_ES_ACCESS_RIGHTS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_ES_ACCESS_RIGHTS: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_CS_ACCESS_RIGHTS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_CS_ACCESS_RIGHTS: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_SS_ACCESS_RIGHTS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_SS_ACCESS_RIGHTS: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_DS_ACCESS_RIGHTS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_DS_ACCESS_RIGHTS: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_FS_ACCESS_RIGHTS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_FS_ACCESS_RIGHTS: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_GS_ACCESS_RIGHTS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_GS_ACCESS_RIGHTS: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_LDTR_ACCESS_RIGHTS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_LDTR_ACCESS_RIGHTS: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_TR_ACCESS_RIGHTS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_TR_ACCESS_RIGHTS: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_INTERRUPTIBILITY_STATE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_INTERRUPTIBILITY_STATE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_ACTIVITY_STATE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_ACTIVITY_STATE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_SMBASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_SMBASE: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_SYSENTER_CS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_SYSENTER_CS: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_VMX_PREEMPTION_TIMER_VALUE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_VMX_PREEMPTION_TIMER_VALUE: 0x%llX", parm);

		// 16-Bit Guest Register State Fields
		__vmx_vmread(VMCS_GUEST_ES_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_ES_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_CS_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_CS_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_SS_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_SS_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_DS_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_DS_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_FS_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_FS_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_GS_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_GS_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_LDTR_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_LDTR_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_TR_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_TR_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_INTERRUPT_STATUS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_GUEST_INTERRUPT_STATUS: 0x%llX", parm);
		__vmx_vmread(VMCS_GUEST_PML_INDEX, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "GUEST_PML_INDEX: 0x%llX", parm);

		// Natural Host Register State Fields
		__vmx_vmread(VMCS_HOST_CR0, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_CR0: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_CR3, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_CR3: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_CR4, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_CR4: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_FS_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_FS_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_GS_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_GS_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_TR_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_TR_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_GDTR_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_GDTR_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_IDTR_BASE, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_IDTR_BASE: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_SYSENTER_ESP, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_SYSENTER_ESP: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_SYSENTER_EIP, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_SYSENTER_EIP: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_RSP, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_RSP: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_RSP, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_RIP: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_S_CET, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_S_CET: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_SSP, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_SSP: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_INTERRUPT_SSP_TABLE_ADDR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_INTERRUPT_SSP_TABLE_ADDR: 0x%llX", parm);

		// 64-bit Host Register State Fields
		__vmx_vmread(VMCS_HOST_PAT, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_PAT: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_EFER, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_EFER: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_PERF_GLOBAL_CTRL, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_PERF_GLOBAL_CTRL: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_PKRS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_PKRS: 0x%llX", parm);

		// 32-bit Host Register State Fields
		__vmx_vmread(VMCS_HOST_SYSENTER_CS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_SYSENTER_CS: 0x%llX", parm);

		// 16-bit Host Register State Fields
		__vmx_vmread(VMCS_HOST_ES_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_ES_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_CS_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_CS_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_SS_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_SS_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_DS_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_DS_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_FS_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_FS_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_GS_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_GS_SELECTOR: 0x%llX", parm);
		__vmx_vmread(VMCS_HOST_TR_SELECTOR, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "HOST_TR_SELECTOR: 0x%llX", parm);

		// Natural Control Register State Fields
		__vmx_vmread(VMCS_CTRL_CR0_GUEST_HOST_MASK, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_CR0_GUEST_HOST_MASK: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_CR4_GUEST_HOST_MASK, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_CR4_GUEST_HOST_MASK: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_CR0_READ_SHADOW, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_CR0_READ_SHADOW: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_CR4_READ_SHADOW, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_CR4_READ_SHADOW: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_CR3_TARGET_VALUE_0, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_CR3_TARGET_VALUE_0: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_CR3_TARGET_VALUE_1, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_CR3_TARGET_VALUE_1: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_CR3_TARGET_VALUE_2, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_CR3_TARGET_VALUE_2: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_CR3_TARGET_VALUE_3, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_CR3_TARGET_VALUE_3: 0x%llX", parm);

		// 64-bit Control Register State Fields
		__vmx_vmread(VMCS_CTRL_IO_BITMAP_A_ADDRESS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_BITMAP_IO_A_ADDRESS: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_IO_BITMAP_B_ADDRESS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_BITMAP_IO_B_ADDRESS: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_MSR_BITMAP_ADDRESS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_MSR_BITMAPS_ADDRESS: 0x%llX", parm);
		...
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_PIN_BASED_VM_EXECUTION_CONTROLS: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_PROCESSOR_BASED_VM_EXECUTION_CONTROLS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_PRIMARY_PROCESSOR_BASED_VM_EXECUTION_CONTROLS: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_EXCEPTION_BITMAP, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_EXCEPTION_BITMAP: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_PAGEFAULT_ERROR_CODE_MASK, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_PAGE_FAULT_ERROR_CODE_MASK: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_PAGEFAULT_ERROR_CODE_MATCH, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_PAGE_FAULT_ERROR_CODE_MATCH: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_CR3_TARGET_COUNT, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_CR3_TARGET_COUNT: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_PRIMARY_VMEXIT_CONTROLS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_VM_EXIT_CONTROLS: 0x%llX", parm);
		__vmx_vmread(VMCS_CTRL_VMEXIT_MSR_STORE_ADDRESS, &parm);
		DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, "CONTROL_VM_EXIT_MSR_STORE_COUNT: 0x%llX", parm);
